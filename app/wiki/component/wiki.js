...
import {level, responseHandle, showLoginModal, timeConclude} from "@/app/component/function";
...
import {
    ...
    LoopOutline,
    MoreOutline, SendOutline, TagOutline,
    UndoOutline,
    UploadOutline, UserOutline
} from "antd-mobile-icons";
import {recaptcha_site_key_v2, Url} from "@/app/(app)/clientConfig";
...
import {getPostLikeList, getUserLikePost} from "@/app/api/serverAction";
        ...
        <>
            ...
            >
                <div style={{
                    ...
                    <NavBar onBack={() => setWikiDetailsVisible(false)}>
                        {focusWiki.SK}
                    </NavBar>
